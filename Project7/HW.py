...
def verify(d1,c,p,photo,sign):
    ...
    for i in range(d1-1):
        ...
        cc1 = c1.hexdigest()
    private_key = '01AC667DEB19002548FCC108750921ABBE0FEA7CDFAC68901AE1679659127953AF'
    public_key = 'E6998B47F05FD2A888B9C3B298E92F631D743728280FF971BA61846697EB24BBF303993HASH2AAE50A8EF818C77DE2468C201B82FD3BE99C273AFF59042623'
    sm2_crypt = sm2.CryptSM2(public_key=public_key, private_key=private_key)
