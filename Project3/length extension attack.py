...
def length_attack(old_hash, secret_len, m2):
    vectors = []
    message = ""
...
start=time.time()
m1 = str(random.random())
hash = sm3.sm3_hash(func.bytes_to_list(bytes(m1, encoding='utf-8')))
m1_len = len(m1)
m2 = "123456789012" #扩展消息
pad_str = ""
pad = []

guess_hash = length_attack(hash, m1_len, m2)
...
print("hash后消息:" + hash)
print("扩展消息:", m2)
print("扩展结果:",guess_hash)
print("hash:" + new_hash)
if new_hash == guess_hash:  #若两者相等，则可以判定攻击成功
    print("攻击成功！")
else:
    print("失败。")
